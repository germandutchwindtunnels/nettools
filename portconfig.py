...
if __name__ == '__main__':
	...
	if 	main_username is not None and \
		...
		print_list(get_available_patchports(default_switch, telnet_port, main_username, main_password))
	elif 	main_username is not None and \
		main_password is not None and \
		main_patchnumber is not None and \
		main_vlanname is None:
		print_list(get_available_vlannames(default_switch, telnet_port, main_username, main_password))
	elif	main_username is not None and \
		main_password is not None and \
		main_patchnumber is not None and \
